...
public class SainsdanMatematika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sains dan Matematika");
    ...
    void lihat() {
        ...
        Call<Value> call = apiInterface.lihatsainsdanmatematika();
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (val.equals("1")) {
                    ...
                    adapter = new rvAdapter(SainsdanMatematika.this, results);
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(SainsdanMatematika.this, "Gagal menghubungi server", Toast.LENGTH_SHORT).show();
