...
public class Sosial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sosial");
    ...
    void lihat() {
        ...
        Call<Value> call = apiInterface.lihatsosial();
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (val.equals("1")) {
                    ...
                    adapter = new rvAdapter(Sosial.this, results);
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(Sosial.this, "Gagal menghubungi server", Toast.LENGTH_SHORT).show();
