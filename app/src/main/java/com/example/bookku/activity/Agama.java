...
public class Agama extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Agama");
    ...
    void lihat() {
        ...
        Call<Value> call = apiInterface.lihatagama();
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (val.equals("1")) {
                    ...
                    adapter = new rvAdapter(Agama.this, results);
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(Agama.this, "Gagal menghubungi server", Toast.LENGTH_SHORT).show();
