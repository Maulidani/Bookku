...
public class Bahasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bahasa");
    ...
    void lihat() {
        ...
        Call<Value> call = apiInterface.lihatbahasa();
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (val.equals("1")) {
                    ...
                    adapter = new rvAdapter(Bahasa.this, results);
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(Bahasa.this, "Gagal menghubungi server", Toast.LENGTH_SHORT).show();
