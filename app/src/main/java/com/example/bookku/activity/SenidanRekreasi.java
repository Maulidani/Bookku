...
public class SenidanRekreasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Seni dan Rekreasi");
    ...
    void lihat() {
        ...
        Call<Value> call = apiInterface.lihatsenidanrekreasi();
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (val.equals("1")) {
                    ...
                    adapter = new rvAdapter(SenidanRekreasi.this, results);
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(SenidanRekreasi.this, "Gagal menghubungi server", Toast.LENGTH_SHORT).show();
