...
public class FilsafatdanPsikologi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Filsafat dan Psikologi");
    ...
    void lihat() {
        ...
        Call<Value> call = apiInterface.lihatfilsafatdanpsikologi();
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (val.equals("1")) {
                    ...
                    adapter = new rvAdapter(FilsafatdanPsikologi.this, results);
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(FilsafatdanPsikologi.this, "Gagal menghubungi server", Toast.LENGTH_SHORT).show();
